...
try:
    ...
    print("ERROR in models.py: Could not import NEW_STATE_DIM from utils.py.")
    print("Ensure utils.py is updated and defines NEW_STATE_DIM.")
    # Define a fallback dimension to allow script loading, but it will likely fail later
    NEW_STATE_DIM = 333 # Fallback - Adjust if different in utils.py
