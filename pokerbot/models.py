...
Modifications in this version:
  • An additional ResidualBlock has been appended to the network (res_block3)
    to slightly increase network depth and capacity. This minimal change allows
    a current model (without the new block) to load using strict=False and continue training.
  • All changes are kept minimal to maintain backward compatibility.
"""
...
class BestPokerModel(nn.Module):
    ...
    The network comprises:
      ...
      - Three ResidualBlocks (the third added in this version),
    ...
    def __init__(self, input_dim: int, num_actions: int) -> None:
        ...
        # New extra residual block for additional capacity.
